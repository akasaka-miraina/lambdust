...
fn test_dynamic_wind_basic_execution() {
    ...
    evaluator.global_env.define("before-count".to_string(), Value::Number(SchemeNumber::Integer(0)));
    evaluator.global_env.define("after-count".to_string(), Value::Number(SchemeNumber::Integer(0)));
    evaluator.global_env.define("thunk-result".to_string(), Value::Number(SchemeNumber::Integer(0)));
...
fn test_nested_dynamic_wind() {
    ...
    // Set up counters
    evaluator.global_env.define("outer-before".to_string(), Value::Number(SchemeNumber::Integer(0)));
    evaluator.global_env.define("outer-after".to_string(), Value::Number(SchemeNumber::Integer(0)));
    evaluator.global_env.define("inner-before".to_string(), Value::Number(SchemeNumber::Integer(0)));
    evaluator.global_env.define("inner-after".to_string(), Value::Number(SchemeNumber::Integer(0)));
    ...
    assert_eq!(evaluator.global_env.get("outer-before").unwrap(), Value::Number(SchemeNumber::Integer(1)));
    assert_eq!(evaluator.global_env.get("inner-before").unwrap(), Value::Number(SchemeNumber::Integer(1)));
    assert_eq!(evaluator.global_env.get("inner-after").unwrap(), Value::Number(SchemeNumber::Integer(1)));
    assert_eq!(evaluator.global_env.get("outer-after").unwrap(), Value::Number(SchemeNumber::Integer(1)));
}