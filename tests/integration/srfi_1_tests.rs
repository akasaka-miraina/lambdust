...
mod tests {
    ...
    fn test_concatenate_function() {
        ...
        let _result = interpreter.eval_string("(concatenate '(1 2) '(3 4) '(5 6))").unwrap();
        // This test verifies the function exists and basic structure
    }
    ...
    fn test_delete_duplicates_function() {
        ...
        let _result = interpreter.eval_string("(delete-duplicates '(1 2 1 3 2 4))").unwrap();
        // This test verifies the function exists and basic structure
    }
    ...
    fn test_srfi_1_library_available() {
        ...
        let functions = vec![
            "take", "drop", "concatenate", "delete-duplicates",
            "fold", "fold-right", "filter", "find", "any", "every"
        ];
    ...
    fn test_concatenate_integration() {
        ...
        let result = interpreter.eval_string("(concatenate '(1 2) '(3 4))").unwrap();
        let expected = Value::from_vector(vec![
            Value::Number(SchemeNumber::Integer(1)),
            Value::Number(SchemeNumber::Integer(2)),
            Value::Number(SchemeNumber::Integer(3)),
    ...
    fn test_filter_integration() {
        ...
        interpreter.eval_string("(define (even? x) (= (remainder x 2) 0))").unwrap();
        
        let result = interpreter.eval_string("(filter even? '(1 2 3 4 5 6))").unwrap();
        let expected = Value::from_vector(vec![
            Value::Number(SchemeNumber::Integer(2)),
            Value::Number(SchemeNumber::Integer(4)),
