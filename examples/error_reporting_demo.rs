...
use lambdust::error::{FrameType, LambdustError, SourcePosition, SourceSpan, StackFrame};
...
fn demo_runtime_error_with_stack_trace() {
    ...
    let error = LambdustError::RuntimeError {
        ...
        context: Box::new(lambdust::error::ErrorContext::new(
            SourceSpan::with_filename(
...
mod tests {
    ...
    fn test_stack_frame_formatting() {
        let frame = StackFrame {
            ...
            location: SourceSpan::new(SourcePosition::new(1, 1, 0), SourcePosition::new(1, 10, 9)),
            frame_type: FrameType::Function,
        };
