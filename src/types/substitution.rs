...
use super::{Constraint, Effect, Row, Type, TypeVar};
...
impl Substitution {
    ...
    pub fn apply_to_type(&self, type_: &Type) -> Type {
        match type_ {
            ...
            Type::Pair(a, b) => Type::pair(self.apply_to_type(a), self.apply_to_type(b)),
            ...
            Type::Constructor { name, kind } => Type::Constructor {
                name: name.clone(),
                kind: kind.clone(),
            },
            Type::Application {
            ...
            Type::Constrained { constraints, type_ } => Type::Constrained {
            ...
            Type::Effectful {
                ...
                effects: effects.iter().map(|e| self.apply_to_effect(e)).collect(),
...
mod tests {
    ...
    fn test_substitution_composition() {
        ...
        assert_eq!(
            composed.apply_to_type(&Type::Variable(var3.clone())),
            Type::Variable(var3)
        );
    }
    ...
    fn test_normalization() {
        ...
        assert_eq!(
            normalized.apply_to_type(&Type::Variable(var1)),
            Type::Number
        );
        assert_eq!(
            normalized.apply_to_type(&Type::Variable(var2)),
            Type::Number
        );
