...
mod tests {
    ...
    #[test]
    fn test_length() {
        let list = Value::list(vec![Value::boolean(true), Value::boolean(false), Value::Nil]);
    ...
    fn test_append() {
        ...
        assert_eq!(result_vec, vec![Value::boolean(true), Value::boolean(false)]);
    }
