...
pub fn create_arithmetic_bindings(env: &Arc<ThreadSafeEnvironment>) {
    ...
    bind_pure_arithmetic_primitive(
        env,
        "floor-remainder",
        2,
        Some(2),
        primitive_floor_remainder,
    );
    bind_pure_arithmetic_primitive(
        env,
        "truncate-quotient",
