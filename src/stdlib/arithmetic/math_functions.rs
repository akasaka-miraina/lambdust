    ...
    match (&args[0], &args[1]) {
        (Value::Literal(crate::ast::Literal::ExactInteger(base)), 
         Value::Literal(crate::ast::Literal::ExactInteger(exp))) => {
            if *exp >= 0 {
                Ok(Value::Literal(crate::ast::Literal::ExactInteger(base.pow(*exp as u32))))
            } else {
                Ok(Value::Literal(crate::ast::Literal::InexactReal((*base as f64).powf(*exp as f64))))
            }
        }
        (Value::Literal(crate::ast::Literal::InexactReal(base)), 
         Value::Literal(crate::ast::Literal::InexactReal(exp))) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal(base.powf(*exp))))
        }
        (Value::Literal(crate::ast::Literal::ExactInteger(base)), 
         Value::Literal(crate::ast::Literal::InexactReal(exp))) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal((*base as f64).powf(*exp))))
        }
        (Value::Literal(crate::ast::Literal::InexactReal(base)), 
         Value::Literal(crate::ast::Literal::ExactInteger(exp))) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal(base.powf(*exp as f64))))
        }
...
pub fn primitive_sqrt(args: &[Value]) -> Result<Value> {
    ...
    match &args[0] {
        Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
            if *x >= 0 {
                Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).sqrt())))
            } else {
...
pub fn primitive_exp(args: &[Value]) -> Result<Value> {
    ...
    match &args[0] {
        Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).exp())))
        }
        Value::Literal(crate::ast::Literal::InexactReal(x)) => {
    ...
    match args.len() {
        1 => {
            ...
            match &args[0] {
                Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
                    if *x > 0 {
                        Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).ln())))
                    } else {
                        Err(crate::diagnostics::Error::runtime_error(
        ...
        2 => {
            ...
            if value > 0.0 && base > 0.0 && base != 1.0 {
                Ok(Value::Literal(crate::ast::Literal::InexactReal(value.log(base))))
            } else {
                Err(crate::diagnostics::Error::runtime_error(
                    "Invalid arguments to log",
                    None,
                ).into())
            }
        }
...
pub fn primitive_sin(args: &[Value]) -> Result<Value> {
    ...
    match &args[0] {
        Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).sin())))
        }
        Value::Literal(crate::ast::Literal::InexactReal(x)) => {
...
pub fn primitive_cos(args: &[Value]) -> Result<Value> {
    ...
    match &args[0] {
        Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).cos())))
        }
        Value::Literal(crate::ast::Literal::InexactReal(x)) => {
...
pub fn primitive_tan(args: &[Value]) -> Result<Value> {
    ...
    match &args[0] {
        Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
            Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).tan())))
        }
        Value::Literal(crate::ast::Literal::InexactReal(x)) => {
...
pub fn primitive_atan(args: &[Value]) -> Result<Value> {
    match args.len() {
        1 => {
            match &args[0] {
                Value::Literal(crate::ast::Literal::ExactInteger(x)) => {
                    Ok(Value::Literal(crate::ast::Literal::InexactReal((*x as f64).atan())))
                }
                Value::Literal(crate::ast::Literal::InexactReal(x)) => {
