#![allow(missing_docs)]//! Lock-Free String Interning System for Phase 8 Optimization
//!
...
impl StringInterner {
    ...
    pub fn stats(&self) -> InternerSnapshot {
        InternerSnapshot {
            ...
            pool_utilization: self.stats.pool_utilization.iter()
