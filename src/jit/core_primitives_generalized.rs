...
// Import macro system
use crate::{
    define_arithmetic_primitive, define_arithmetic_primitive_impl,
    define_comparison_primitive, define_comparison_primitive_impl,
    define_type_predicate, define_type_predicate_impl,
    define_list_primitive, define_list_primitive_impl,
    define_jit_primitive, define_jit_primitive_impl
};
...
fn register_arithmetic_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    ...
    // Define missing arithmetic primitives
    pub struct AddPrimitive;
    pub struct SubtractPrimitive;  
    pub struct MultiplyPrimitive;
    pub struct DividePrimitive;
...
fn register_comparison_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    ...
    // Define missing comparison primitives
    pub struct EqualPrimitive;
    pub struct LessThanPrimitive;
    pub struct GreaterThanPrimitive;
    pub struct LessEqualPrimitive;
    pub struct GreaterEqualPrimitive;
...
fn register_type_predicate_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    // Number?
    define_type_predicate!("number?", |value| matches!(value, Value::Number(_)));
...
fn format_value_for_display(value: &Value) -> String {
    match value {
        Value::Literal(literal) => match literal {
            Literal::ExactInteger(n) => n.to_string(),
            Literal::InexactReal(n) => n.to_string(),
