...
fn register_arithmetic_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    ...
    // Register all arithmetic primitives generated by macros
    registry.register(AddArithmeticPrimitive)?;
    registry.register(SubtractArithmeticPrimitive)?;
    registry.register(MultiplyArithmeticPrimitive)?;
    registry.register(DivideArithmeticPrimitive)?;
...
fn register_comparison_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    ...
    // Register comparison primitives generated by macros
    registry.register(EqualComparisonPrimitive)?;
    registry.register(LessThanComparisonPrimitive)?;
    registry.register(GreaterThanComparisonPrimitive)?;
...
fn register_list_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    ...
    registry.register(ConsListPrimitive)?;
    registry.register(CarListPrimitive)?;
    registry.register(CdrListPrimitive)?;
    registry.register(NullQuestionListPrimitive)?;
    registry.register(PairQuestionListPrimitive)?;
...
fn register_type_predicate_primitives(registry: &mut GenericPrimitiveRegistry) -> crate::diagnostics::Result<()> {
    ...
    registry.register(NumberQuestionPredicatePrimitive)?;
    registry.register(StringQuestionPredicatePrimitive)?;
    registry.register(SymbolQuestionPredicatePrimitive)?;
...
fn values_eqv(a: &Value, b: &Value) -> bool {
    match (a, b) {
        (Value::Literal(Literal::Number(x)), Value::Literal(Literal::Number(y))) |
        (Value::Literal(Literal::InexactReal(x)), Value::Literal(Literal::InexactReal(y))) => {
            (x - y).abs() < f64::EPSILON
        },
        (Value::Literal(Literal::ExactInteger(x)), Value::Literal(Literal::ExactInteger(y))) => x == y,
...
mod tests {
    ...
    fn test_equality_primitives() {
        ...
        match result {
            Value::Literal(Literal::Boolean(b)) => assert_eq!(b, true),
