...
pub type LegacyMetricsManager = crate::performance_monitor::performance_measurement::MetricsManager;
...
pub type LegacyBenchmarkSuite = crate::performance_monitor::performance_measurement::BenchmarkSuite;
...
pub type LegacyAnalysisEngine = crate::performance_monitor::performance_measurement::AnalysisEngine;
...
/// ## Before:
/// ```ignore
/// use crate::performance_monitor::performance_measurement_system::{
...
/// ## After:
/// ```ignore
/// use crate::performance_monitor::performance_measurement::{
///     PerformanceMeasurementSystem, MetricsManager, BenchmarkSuite
/// };
/// ```
/// 
