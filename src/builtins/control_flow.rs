    ...
    Value::Procedure(Procedure::Builtin {
        ...
        func: |args| {
            ...
            Err(LambdustError::RuntimeError {
                message: "call/cc: requires evaluator integration - not yet fully implemented".to_string(),
...
fn dynamic_wind_function() -> Value {
    Value::Procedure(Procedure::Builtin {
        ...
        func: |args| {
            ...
            // A complete implementation would require evaluator integration
            Err(LambdustError::RuntimeError {
                message: "dynamic-wind: requires evaluator integration - not yet fully implemented".to_string(),
                location: crate::error::SourceSpan::unknown(),
                stack_trace: Vec::new(),
            })
        },
