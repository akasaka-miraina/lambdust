...
mod tests {
    ...
    fn test_nested_ellipsis_processor_creation() {
        ...
        assert_eq!(processor.max_nesting_depth, 10);
        
        let custom_processor = NestedEllipsisProcessor::with_max_depth(5);
        assert_eq!(custom_processor.max_nesting_depth, 5);
    }
    
    #[test]
    fn test_ellipsis_context() {
    ...
    fn test_multi_dim_value_creation() {
        ...
        assert!(matches!(scalar, MultiDimValue::Scalar(_)));
        
        let array1d = MultiDimValue::Array1D(vec![
            Expr::Variable("a".to_string()),
            Expr::Variable("b".to_string()),
        ]);
        assert!(matches!(array1d, MultiDimValue::Array1D(_)));
    }
    ...
    #[test]
    fn test_ellipsis_metrics() {
        let mut metrics = EllipsisMetrics::default();
        metrics.pattern_matches_attempted = 10;
        metrics.pattern_matches_successful = 8;
