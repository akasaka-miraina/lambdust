...
mod tests {
    ...
    fn test_range_intersection() {
        let range1 = Range::new(Position::new(1, 0), Position::new(2, 0));
        let range2 = Range::new(Position::new(1, 5), Position::new(2, 5));
        
        let intersection = range1.intersection(&range2);
        assert!(intersection.is_some());
        
        let intersect = intersection.unwrap();
        assert_eq!(intersect.start, Position::new(1, 5));
        assert_eq!(intersect.end, Position::new(2, 0));
    }
}