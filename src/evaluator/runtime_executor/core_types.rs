...
//!
//! このモジュールはRuntime Executorで使用される基本構造体と
//! 型定義を提供します。
//!
...
use crate::evaluator::{
    ...
    IntegratedOptimizationManager, JitLoopOptimizer, SemanticEvaluator,
...
impl HotPathDetector {
    ...
    pub fn get_frequency(&self, expr_hash: &str) -> u64 {
...
impl RuntimeExecutor {
    ...
    pub fn semantic_evaluator(&self) -> &SemanticEvaluator {
    ...
    pub fn llvm_compiler(&self) -> &LLVMCompilerIntegration {
        &self.llvm_compiler
    }
    ...
    pub fn jit_optimizer(&self) -> &JitLoopOptimizer {
        &self.jit_optimizer
    }
    ...
    pub fn hotpath_detector(&self) -> &crate::evaluator::hotpath_analysis::AdvancedHotPathDetector {
        &self.hotpath_detector
    }
    
    /// Get mutable reference to hotpath detector
    pub fn hotpath_detector_mut(&mut self) -> &mut crate::evaluator::hotpath_analysis::AdvancedHotPathDetector {
    ...
    pub fn continuation_pooler(&self) -> &crate::evaluator::continuation_pooling::ContinuationPoolManager {
    ...
    pub fn inline_evaluator(&self) -> &crate::evaluator::InlineEvaluator {
        &self.inline_evaluator
    }
    
    /// Get adaptive engine reference
    pub fn adaptive_engine(&self) -> &AdaptiveOptimizationEngine {
    ...
    pub fn integrated_optimizer(&self) -> &crate::evaluator::runtime_optimization::IntegratedOptimizationManager {
        &self.integrated_optimizer
    }
    
    /// Get mutable reference to integrated optimizer
    pub fn integrated_optimizer_mut(&mut self) -> &mut crate::evaluator::runtime_optimization::IntegratedOptimizationManager {
