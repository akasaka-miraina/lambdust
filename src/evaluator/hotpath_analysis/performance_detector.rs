...
impl PerformanceRegressionDetector {
    ...
    pub fn get_alerts(&self) -> Vec<PerformanceRegressionAlert> {
    ...
    pub fn get_performance_trend(&self, expr_hash: &str) -> Option<PerformanceTrend> {
        let history = self.performance_history.get(expr_hash)?;
    ...
    pub fn generate_optimization_recommendations(&self, expr_hash: &str) -> Vec<OptimizationRecommendation> {
