...
impl MemoryAccessAnalyzer {
    ...
    pub fn get_access_pattern(&self, expr_hash: &str) -> Option<&MemoryAccessPattern> {
    ...
    pub fn identify_memory_hotspots(&self, threshold: usize) -> Vec<MemoryHotspot> {
    ...
    pub fn analyze_locality(&self, expr_hash: &str) -> Option<LocalityAnalysis> {
        ...
        Some(LocalityAnalysis {
            temporal_locality,
            spatial_locality,
            overall_locality: (temporal_locality + spatial_locality) / 2.0,
        })
    }
